                ...
                <div class="card card-gray">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-daterange input-group" id="datepicker">
                            ...
                            <div class="col-4">
                            <input class="input-sm form-control" name="start" value="{{ $curent_date_minus_a_week }}" type="text">
                            </div>
                            <div class="col-1">
                                <p class="text-center">To</p>
                            </div>
                            <div class="col-4">
                            <input class="input-sm form-control" name="end" value="{{ $curent_date }}" type="text">
                            </div>
                            <div class="col-2">
